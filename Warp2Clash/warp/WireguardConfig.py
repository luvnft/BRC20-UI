    ...
    with open(file_path, 'r') as file:
        ...
        with open('res.txt', 'w') as output_file:
            for i, row in enumerate(reader, start=1):
                ...
                new_line = f"- {{name: {warp_name},type: wireguard,server: {ip},port: {port},ip: 172.16.0.2,public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=,private-key: GC7TPwjIjDJ3cBWQf54+F4kJSG3j2w0+s9mWHUVMjUA=,mtu: 1280,udp: true}}\n"
