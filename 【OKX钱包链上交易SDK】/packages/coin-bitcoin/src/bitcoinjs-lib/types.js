...
var EC_P = buffer_1.Buffer.from('fffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f', 'hex');
function isPoint(p) {
...
function isTaptree(scriptTree) {
    ...
    if (scriptTree.length !== 2)
        return false;
    return scriptTree.every(function (t) { return isTaptree(t); });
}
